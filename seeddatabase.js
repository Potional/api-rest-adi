...
db.serialize(function() {
    ...
    db.run("CREATE TABLE IF NOT EXISTS `Juego` ( `ID` INTEGER PRIMARY KEY AUTOINCREMENT, `nombre` TEXT, `descripcion` TEXT, `trailer` BLOB, `edad_recomendada` INTEGER, `Requerimientos` TEXT, `desarrolladora_id` INTEGER, FOREIGN KEY(`desarrolladora_id`) REFERENCES `Categoria`(`ID`) ON DELETE SET NULL )");
