...
db.serialize(function() {
    ...
    db.run("INSERT INTO `Juego`(`ID`,`nombre`,`descripcion`,`trailer`,`edad_recomendada`,`Requerimientos`,`precio`,`desarrolladora_id`) VALUES (NULL,'Star Wars: Battlefront','Juego magnifico 10/10 - IGN','https://youtu.be/ZwWLns7-xN8',18,'Windows 64-bits',60,2);");
    db.run("INSERT INTO `Juego`(`ID`,`nombre`,`descripcion`,`trailer`,`edad_recomendada`,`Requerimientos`,`precio`,`desarrolladora_id`) VALUES (NULL,'Spiderman','Un buen juego de Spiderman','https://youtu.be/q4GdJVvdxss',18,'PS4',60,3);");
    db.run("INSERT INTO `Juego`(`ID`,`nombre`,`descripcion`,`trailer`,`edad_recomendada`,`Requerimientos`,`precio`,`desarrolladora_id`) VALUES (NULL,'Nier:Automata','Un buen juego de Nier','https://youtu.be/YKI1Jh43Ju8',18,'PS4',60,4);");
